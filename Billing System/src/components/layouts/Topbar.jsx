...
export default function Topbar({ sidebarCollapsed }) {
  ...
  return (
    <header
      className={`fixed right-0 top-0 z-20 flex h-20 items-center justify-between border-b border-slate-200/60 bg-white/80 px-4 backdrop-blur-xl transition-all duration-300 dark:border-slate-700/60 dark:bg-slate-900/80 sm:px-6 ${sidebarCollapsed ? 'left-[72px]' : 'left-64'}`}
    >
